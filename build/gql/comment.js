...
let CommentResolver = class CommentResolver {
    createComment(commentInput) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield typeorm_1.createEntity(models_1.Comment, commentInput);
        });
    }
    updateComment(commentId, commentInput) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield typeorm_1.updateEntity(models_1.Comment, commentId, commentInput);
        });
    }
    deleteComment(commentId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield typeorm_1.deleteEntity(models_1.Comment, commentId);
        });
    }
};
__decorate([
    type_graphql_1.UseMiddleware([isAuth_1.IsAuth, errorInterceptor_1.ErrorInterceptor]),
    type_graphql_1.Mutation(() => models_1.Comment),
    __param(0, type_graphql_1.Arg("comment")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [types_1.CommentInput]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, types_1.CommentInput]),
    __metadata("design:returntype", Promise)
